    ...
    <section className="relative text-gray-600 body-font">
      <div className="container px-5 py-24 mx-auto">
        <div className="flex flex-col w-full mb-12 text-center">
          ...
          <p className="mx-auto text-base leading-relaxed lg:w-2/3">Please get in touch</p>
        </div>
        <form action="https://viajeslovetravels.web.app/{form-id}" method="post">
        {/* wa.link/mhinmk https://www.instagram.com/lovetravels_turism?igsh=d3l0djJzZ2g3cDA1 */}
          <div className="mx-auto lg:w-1/2 md:w-2/3">
            <div className="flex flex-wrap -m-2">
              ...
              <div className="w-full p-2">
                <button type="submit" className="flex px-8 py-2 mx-auto text-lg text-white bg-green-600 border-0 rounded focus:outline-none hover:bg-green-700">Enviar</button>
              </div>
              <div className="w-full p-2 pt-8 mt-8 text-center border-t border-gray-200">
                
                <p className="my-5 leading-normal">Medellin, Antioquia<br />Colombia</p>
